...
MixtureOfAgents_dir = os.path.join(current_dir, 'MixtureOfAgents')
sys.path.append(current_dir)
moa_groq = os.path.join(current_dir, 'MixtureOfAgents','static','banner.png')
...
from MixtureOfAgents.moa.agent import MOAgent
from MixtureOfAgents.moa.agent.moa import ResponseChunk, MOAgentConfig
from MixtureOfAgents.moa.agent.prompts import SYSTEM_PROMPT, REFERENCE_SYSTEM_PROMPT
...
'''
# Default configuration  "llama-3.1-70b-versatile","llama-3.1-8b-instant"
...
with st.status("Current MOA Configuration", expanded=True, state='complete') as config_status:
    st.image(moa_groq, caption="Mixture of Agents Workflow", use_column_width='always')
